...
# 18608-vertical-volume-control
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-vertical-volume-control.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>vertical-volume.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>vertical-volume.css</strong>.</td>
    </tr>
  </tbody>
</table>
